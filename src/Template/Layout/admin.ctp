...
<body>
    <nav class="navbar navbar-expand navbar-dark bg-primary">
        ...
        <a class="navbar-brand" href="#">Solutudo</a>
    ...
    <div class="d-flex">
        ...
        <div class="content p-1">
            <div class="list-group-item">
                <?= $this->Flash->render() ?> <!-- resposável pelas msgs de erro -->
                <?= $this->fetch('content') ?> <!-- carrega o conteudo da página -->
            </div>
        </div>
    </div>

    <?= $this->Html->script([
        'jquery-3.3.1.min.js', 'bootstrap.min.js',
        'popper.min', 'dashboard'
    ]) ?>
</body>
